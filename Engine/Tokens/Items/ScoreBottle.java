...
public class ScoreBottle extends Item{
    ...
    public ScoreBottle(float x, float y){
        defaultVals(x, y);
    }

    public ScoreBottle(float x, float y, Player player, GraphicRenderer renderer){
        defaultVals(x, y);
        this.player = player;
    ...
    private void defaultVals(float x, float y){
        ...
        this.icon = ImageLoader.getImage("src/Art/Items/Score potion/Icon.png");
        animationLength = 1000;
        srcs = new Image[]{ImageLoader.getImage("src/Art/Items/Score potion/1.png"),
                ImageLoader.getImage("src/Art/Items/Score potion/2.png"),
                ImageLoader.getImage("src/Art/Items/Score potion/3.png"),
                ImageLoader.getImage("src/Art/Items/Score potion/4.png")};
    }
